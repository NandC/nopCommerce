...
namespace Nop.Plugin.Widgets.ProdMsg.Infrastructure.Cache
{
    /// <summary>
        ...
        IConsumer<EntityDeleted<Setting>>
    {
        ...
        /// {0} : picture id
        /// </remarks>
        public const string PICTURE_URL_MODEL_KEY = "Nop.plugins.widgets.ProdMsg.pictureurl-{0}";
        public const string PICTURE_URL_PATTERN_KEY = "Nop.plugins.widgets.ProdMsg";
